...
public class Analyze {
  ...
  public static void main(String[] args) throws UnsupportedEncodingException {
    String s = new Analyze().regexMain("VoteClientUDP.java");
    System.out.println(s);
  }

  public String regexMain(String className) throws UnsupportedEncodingException {
//    String url="http://cs.ecs.baylor.edu/~donahoo/practical/JavaSockets2/code/"+className;
    String url="http://cs.ecs.baylor.edu/~donahoo/practical/JavaSockets2/textcode.html";
    String result = ConnectionUtil.Connect(url);
    String allA = getAllA(result);
    return result;
//    return getHouseInfo(result);
  }

  private String getAllA(String str) {
    Pattern pattern = Pattern.compile("</a><li><a href=*\\.java</a><li>");
